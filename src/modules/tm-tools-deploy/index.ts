...
export class TmToolsDeploy {
  ...
  // Private Members
  private _mainDeploymentResult:            DeployResult;
   ...
   */
  //───────────────────────────────────────────────────────────────────────────┘
  public async deployMainMetadata():Promise<DeployResult> {
    ...
    .then(successResult => {
      ...
      this._mainDeploymentResult = successResult.detail['stdOutParsed']['result'] as DeployResult;
    })
    .catch(errorResult => {
  ...
  public generateReport():TM2DeploymentReport {
    const tm2DeploymentReport:TM2DeploymentReport = {
      ...
      deploymentResult: this._mainDeploymentResult
    };
