...
//import {TM1CleanupReport}         from  '../tm-tools-types';      // Interface. Represents the data that is generated by a TM1 Cleanup Report.
 ...
 */
// ────────────────────────────────────────────────────────────────────────────────────────────────┘
export function loadTm2Config(tm1AnalysisReport:TM1AnalysisReport, tm1ExtractionReport:TM1ExtractionReport, tm1TransformationReport:TM1TransformationReport, tm2DeploymentReport:TM2DeploymentReport, tm2DataLoadFilePaths:TM2DataLoadFilePaths):ListrObject {

  // Validate incoming arguments.
  typeValidator.throwOnNullInvalidObject(tm1AnalysisReport,       `${dbgNs}:loadTm2Config`, 'tm1AnalysisReport');
  typeValidator.throwOnNullInvalidObject(tm1ExtractionReport,     `${dbgNs}:loadTm2Config`, 'tm1ExtractionReport');
  typeValidator.throwOnNullInvalidObject(tm1TransformationReport, `${dbgNs}:loadTm2Config`, 'tm1TransformationReport');
  typeValidator.throwOnNullInvalidObject(tm2DeploymentReport,     `${dbgNs}:loadTm2Config`, 'tm2DeploymentReport');
  typeValidator.throwOnNullInvalidObject(tm2DataLoadFilePaths,    `${dbgNs}:loadTm2Config`, 'tm2DataLoadFilePaths');
 ...
 */
// ────────────────────────────────────────────────────────────────────────────────────────────────┘
export function validateTm2Activation(tm2DeploymentReport:TM2DeploymentReport, tm2DataLoadFilePaths:TM2DataLoadFilePaths):ListrObject {

  // Validate incoming arguments.
  typeValidator.throwOnNullInvalidObject(tm2DeploymentReport,   `${dbgNs}:validateTm2Activation`, 'tm2DeploymentReport');
  typeValidator.throwOnNullInvalidObject(tm2DataLoadFilePaths,  `${dbgNs}:validateTm2Activation`, 'tm2DataLoadFilePaths');
