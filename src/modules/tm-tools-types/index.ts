 ...
 */
export interface TM2CleanupStatus extends JsonMap {
...
/**
 * Interface. Represents the data that is generated by a TM2 Cleanup Report.
 */
export interface TM2CleanupReport extends JsonMap {
  orgInfo:              TM1OrgInfo;
  status:               TM2CleanupStatus;
}
