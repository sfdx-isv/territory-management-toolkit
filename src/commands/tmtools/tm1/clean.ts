 ...
 * @description   Salesforce CLI Plugin command `tmtools:tm1:clean`. Allows a Salesforce Admin
 *                to....
 */
//─────────────────────────────────────────────────────────────────────────────────────────────────┘
...
const commandMessages = Messages.loadMessages('territory-management-toolkit', 'tmtools-tm1-clean');
 ...
 * @summary     Implements the CLI Command `tmtools:tm1:clean`.
 * @description The command `tmtools:tm1:clean` asks the user to specify a directory that...
 *              TODO: Finish documentation of this class.
 * @public
 */
//─────────────────────────────────────────────────────────────────────────────────────────────────┘
export default class TmtoolsTm2Clean extends SfdxFalconGeneratorCommand {
