 ...
 * @description   Salesforce CLI Plugin command `tmtools:tm2:deploysharing`. Allows a Salesforce Admin
 ...
 * @summary     Implements the CLI Command `tmtools:tm2:deploysharing`.
 * @description The command `tmtools:tm2:deploysharing` asks the user to...
 *              TODO: Add description
 * @public
 */
//─────────────────────────────────────────────────────────────────────────────────────────────────┘
export default class TmtoolsTm2DeploySharing extends SfdxFalconGeneratorCommand {
