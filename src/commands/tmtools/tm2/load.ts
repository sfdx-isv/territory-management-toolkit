 ...
 * @description   Salesforce CLI Plugin command `tmtools:tm2:load`. Allows a Salesforce Admin
 *                to...
 ...
 * @summary     Implements the CLI Command `tmtools:tm2:load`
 * @description The command `tmtools:tm2:load` asks the uer to...
 *              TODO: Add description
 * @public
 */
//─────────────────────────────────────────────────────────────────────────────────────────────────┘
export default class TmtoolsTm2Load extends SfdxFalconGeneratorCommand {
