...
import {TM1AnalysisReport, TM1TransformFilePaths}              from  '../modules/tm-tools-types';                        // Interface. Represents the data that is generated by a TM1 Analysis Report.
...
protected tm1TransformFilePaths:       TM1TransformFilePaths;       // Holds a complete set of known (and knowable) file paths needed by the Transform command.
  ...
  constructor(args:string|string[], opts:GeneratorOptions) {
    ...
    this.sharedData['tm1DeploymentReport']  = {};                   // ???
  }
